...
namespace System
{
    ...
    public static class Ensure
    {
        ...
        public static class Argument
        {
            ...
            public static void IsNotNullOrEmpty<TSource>(IEnumerable<TSource> source, string paramName = "")
            {
                if (source == null || !source.Any())
                {
                    throw new ArgumentException("paramater " + paramName + " cannot be null or empty");
                }
            }
        }
    }
